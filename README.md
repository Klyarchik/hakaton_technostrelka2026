...
5. Push-уведомления работать не будут, тк для этого требуется секретный ключ от firebase, поэтому в склонированном проекте push-уведомления отсутствуют (при открытии деплоя уведомления доступны)
